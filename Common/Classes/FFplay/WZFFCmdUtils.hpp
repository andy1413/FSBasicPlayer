...
#define GROW_ARRAY_Option(array, nb_elems)\
    array = (OptionGroup *)grow_array((void *)array, sizeof(*array), &nb_elems, nb_elems + 1)
#define GROW_ARRAY(array, nb_elems)\
    array = (char **)grow_array((void *)array, sizeof(*array), &nb_elems, nb_elems + 1)
...
public:
    ...
    void expand_filename_template(AVBPrint *bp, const char *template_c,
                                              struct tm *tm);
